...
#define Max_stws_before_suspend 2
  ...
  */
  ...
  domain_state->cont_major_todo_head = Val_long(0);
  domain_state->cont_major_toclean_head = Val_long(0);
  domain_state->cont_minor_todo_head = Val_long(0);
  caml_register_generational_global_root(&domain_state->cont_major_toclean_head);
...
create_stack_cache_failure:
  caml_remove_generational_global_root(&domain_state->cont_major_toclean_head);
